...
import { deletePlaylist, renamePlaylist } from "../../Utils/serverRequest";
...
export const PlaylistHeader = ({ name, listId }) => {
    ...
    const updateName = async () => {
      await renamePlaylist(userData._id, listId, listName, dispatch, setShowLoader );
      setEditable(false);
    };
    ...
    const deleteList = async () => {
        await deletePlaylist(userData._id, listId, dispatch, setShowLoader);
    };
